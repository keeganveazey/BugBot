...
print("Devices:", tf.config.list_logical_devices('GPU'))
...
class TunableDenseNet201(kt.HyperModel):
    ...
    def build(self, hp):
        ...
        with tf.device('/GPU:0'):  # Force model to use GPU
    ...
    def fit(self, hp, model, *args, **kwargs):
        '''fits customized DenseNet201 model with tunable batch size'''
...
if __name__ == "__main__":
    ...
    # run 0)  python DenseNet201_run_tuner_script.py --epochs 30 --patience 3 --min_delta 0.001 --executions_per_trial 1 --max_trials 20
    # run 1)  python DenseNet201_run_tuner_script.py --epochs 30 --patience 5 --min_delta 0.001 --executions_per_trial 1 --max_trials 20
    # run 2) python DenseNet201_run_tuner_script.py --epochs 30 --patience 5 --min_delta 0.001 --executions_per_trial 3 --max_trials 60
    # run 3) python DenseNet201_run_tuner_script.py --epochs 64 --patience 10 --min_delta 0.0001 --executions_per_trial 1 --max_trials 20
    # run 4) python DenseNet201_run_tuner_script.py --epochs 20 --patience 3 --min_delta 0.001 --executions_per_trial 1 --max_trials 20
